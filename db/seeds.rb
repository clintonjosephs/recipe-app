...
Food.create(user_id:1, price:"$9", name:"Mashroom", measurement_unit:"1kg")
Food.create(user_id:1, price:"$5", name:"Tomato salads", measurement_unit:"2kg")
Food.create(user_id:1, price:"$3", name:"Cucumber", measurement_unit:"1kg")
Food.create(user_id:1, price:"$2", name:"Chicken soup", measurement_unit:"1kg")
Food.create(user_id:1, price:"$60", name:"Cake", measurement_unit:"8kg")
...
Recipe.create(name:"Chicken", preparation_time:"2 hours", cooking_time:"1 hour", description:"Good taste", public:false, user_id:1)
